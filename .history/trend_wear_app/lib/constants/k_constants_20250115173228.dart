...
List<IconData> kBottomBarIcons = <IconData>[
  CupertinoIcons.home,
  CupertinoIcons.heart,
  CupertinoIcons.cart,
];

List<String> kBottomBarLabels = <String>[
  'Home',
  'Favorite',
  'Cart',
];

class BottomNavigationIconAndLabel {
  final IconData iconData;
  final String label;

 const BottomNavigationIconAndLabel(this.iconData, this.label);
