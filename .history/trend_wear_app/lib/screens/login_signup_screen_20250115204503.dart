              ...
              children: [
                ...
                CupertinoButton(
                  ...
                  onPressed: () {
                    ...
                    var snackAlert = ScaffoldMessenger.of(context);
                    // For login
                    if (togglerCubit.state) {
                      if (_email != null && _password != null) {
                        context.read<LoginCubit>().login(_email!, _password!);
                      } else {
                        snackAlert.showSnackBar(SnackBar(content: 'Please enter correct details'.text.make()));
                      }
                    }
                    // For signup
                    else {
                      if (_email != null && _password != null) {
                        if (_password == _confirmPassword) {
                          ...
                          snackAlert.showSnackBar(
                            SnackBar(content: 'Password and Confirm Password should be same'.text.make()),
                          );
                        }
                      } else {
                        snackAlert.showSnackBar(
                          SnackBar(content: 'Please enter correct details'.text.make()),
                        );
                      }
                    }
                  },
