...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BlocProvider<BottomNavigationIndex>(
        create: (context) => BottomNavigationIndex(),
        child: BlocBuilder<BottomNavigationIndex, int>(builder: (context, currentIndex) {
          return SalomonBottomBar(
            onTap: (clickedIndex) => context.read<BottomNavigationIndex>().updateIndex(clickedIndex),
