...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
  var visibility = TogglePasswordVisibility();
  @override
  void initState() {
    visibility.sinkVisibility.add(false);
    super.initState();
  }
        ...
        children: [
          ...
          AnimatedContainer(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  MyTextField(prefixIcon: Icons.email, onChange: (_) => debugPrint(_)),
                  SizedBox(height: kScreenMargin),
                  MyTextField(prefixIcon: Icons.lock, onChange: (_) => debugPrint(_)),
                ],
              ),
            ),
          )
