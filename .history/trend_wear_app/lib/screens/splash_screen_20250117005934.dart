  ...
  void navigateUser() {
    isAuthenticated
        ? Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (_) => SlideInRight(animate: false, child: const NavigationScreen())),
          )
        : Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (_) => SlideInRight(animate: false, child: const LoginSignupScreen())),
          );
  }
        ...
        children: [
          Lottie.asset(
            ...
            onLoaded: (composition) {
              ...
              _controller.forward();
              Future.delayed(composition.duration * 0.8).then((value) => navigateUser());
            },
          ),
