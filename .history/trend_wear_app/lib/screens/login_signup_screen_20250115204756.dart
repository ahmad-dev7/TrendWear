...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
  ...
  Widget build(BuildContext context) {
    void snackAlert(Widget content) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: content, backgroundColor: kSolidAccentColor));
    }
                  ...
                  onPressed: () {
                    ...
                    if (togglerCubit.state) {
                      if (_email != null && _password != null) {
                        ...
                        snackAlert('Please enter correct details'.text.red400.make());
                      }
                    }
                    // For signup
                    else {
                      if (_email != null && _password != null) {
                        if (_password == _confirmPassword) {
                          ...
                          snackAlert('Password & Confirm password should be same'.text.red400.make());
                        }
                      } else {
                        snackAlert('Please enter correct details'.text.red400.make());
                      }
